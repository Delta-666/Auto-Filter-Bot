...
# Bot information
API_ID = environ.get('API_ID', '29120398')
if len(API_ID) == 0:
    print('Error - API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', '38b3c8e3aa4d97da41e5e16db185e9a9')
if len(API_HASH) == 0:
    print('Error - API_HASH is missing, exiting now')
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '7121443773:AAFbJDWDM-R1vvqDtjPrqtabAmnpL2f_6ck')
if len(BOT_TOKEN) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '6756246365')
if len(ADMINS) == 0:
...
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1002105446363').split()]
if len(AUTH_CHANNEL) == 0:
    print('Info - AUTH_CHANNEL is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002105446363')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002092813256')
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002105446363")
